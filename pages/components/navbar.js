        ...
        <div>
            <nav class="bg-blue-500 text-black ">
                <div class="container mx-auto px-6 py-4 flex items-center">
                    <Link href="/" class="text-5xl font-semibold font-Bangers tracking-custom">Fred Burke</Link>
                    <div class="ml-auto flex items-center">
                        <Link href="/about" class="px-3 py-2 rounded-md text-3xl font-medium leading-5 text-black-700 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700">About</Link>
                        <Link href="/projects" class="px-3 py-2 rounded-md text-3xl font-medium leading-5 text-black-700 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700">Projects</Link>
                        <Link href="/contact" class="px-3 py-2 rounded-md text-3xl font-medium leading-5 text-black-700 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700">Contact</Link>
                    </div>
                    <div class={`md:hidden ${isOpen ? 'flex ml-auto' : 'hidden'}`}>
            ...
            <button
                ...
                <FiMenu class={`w-6 h-6 ${isOpen ? 'hidden' : 'block'}`} />
                <svg
